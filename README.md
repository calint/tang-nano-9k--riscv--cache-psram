...
* screenshots of how to configure the IP blocks used can be found in the ['/notes/ip-blocks-gui-configuration'](https://github.com/calint/tang-nano-9k--riscv--cache-psram/tree/main/notes/ip-blocks-gui-configuration)
